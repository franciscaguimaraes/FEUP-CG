...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        // madeira (no diffuse, no specular)
        this.madeira = new CGFappearance(this);
        this.madeira.setAmbient(0.5, 0.3, 0, 1.0);
        this.madeira.setDiffuse(0.1, 0.15, 0.1, 1.0);
        this.madeira.setSpecular(0.1, 0.1, 0.1, 1.0);
        ...
        this.materials = [this.madeira, this.material1, this.material2, this.material3, this.customMaterial];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Madeira':0, 'Red Ambient': 1, 'Red Diffuse': 2, 'Red Specular': 3, 'Custom': 4};
    }
    display() {
